		...
		return (
			<div className='list-books'>
				...
				<div className='list-books-content'>
					<div>
						<BookSection sectionBooks={this.books.currentlyReading} sectionTitle='Currently Reading' />
                        <BookSection sectionBooks={this.books.wantToRead} sectionTitle='Want to Read' />
                        <BookSection sectionBooks={this.books.read} sectionTitle='Read' />
					</div>
				</div>
				<div className='open-search'>
					<button onClick={() => this.props.setSearchPage(true)}>
						Add a book
					</button>
				</div>
			</div>
